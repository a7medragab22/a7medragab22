...
class AhmedRagab extends Developer {
  ...
  final List<String> education = ['B.Sc. Computer Science - Modern Academy (2022 - 2026)'];

  final List<String> skills = [
    'Dart', 'Flutter', 'REST APIs', 'Firebase',
    'Hive Database', 'BLoC', 'Cubit', 'Clean Architecture',
...
<a href="tel:+201091244780"><img src="https://img.shields.io/badge/Phone-25D366?style=for-the-badge&logo=whatsapp&logoColor=white" /></a>
